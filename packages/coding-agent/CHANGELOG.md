...
- Bumped to v0.84.3-b1 (fork build on upstream v0.84.3 baseline)
- Per-session default model: each .pi-session file carries its own model preference, written to the session file header instead of global settings
