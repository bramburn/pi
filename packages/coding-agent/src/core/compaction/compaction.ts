...
export async function completeSummarization(
	...
	// Reuse caller-supplied routing when available; callers without a session ID,
	// including branch summaries, receive a fresh routing ID.
...
async function generateTurnPrefixSummary(
	...
	if (response.stopReason === "length") {
		throw new Error("Turn prefix summarization failed: generation hit the token cap and the summary is incomplete");
	}
